 ...
 */
QOCOFloat lp_step_length(const QOCOFloat* x,
                         const QOCOFloat* dx,
                         QOCOInt n,
                         QOCOFloat alpha_max)
{
 ...
 */
QOCOFloat soc_step_length(const QOCOFloat* x,
                          const QOCOFloat* dx,
                          QOCOInt n,
                          QOCOFloat alpha_max)
{
  ...
  if (c < 0.0) c = 0.0; // numerical safeguard
  ...
  if (r1 < 0.0) r1 = QOCOFloat_MAX;
  if (r2 < 0.0) r2 = QOCOFloat_MAX;
...
QOCOFloat cone_step_length(QOCOFloat* u, QOCOFloat* Du,
                           QOCOProblemData* data)
{
  QOCOFloat alpha = 1.0;   // <-- key design choice
                     ...
                     QOCOSolver* solver)
{
  ...
  QOCOFloat alpha = cone_step_length(
      u, Du, work->data);
